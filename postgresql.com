...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-09-04T06:00:03.539217" />
  ...
  <link href="/media/css/fontawesome.css?091761a7" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
  <link rel="stylesheet" type="text/css" href="/dyncss/base.css?091761a7">

  <script src="/media/js/theme.js?091761a7"></script>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/cve-2020-21469-is-not-a-security-vulnerability-2701/">CVE-2020-21469 is not a security vulnerability</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-08-29 by PostgreSQL Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v76-released-2698/">pgAdmin 4 v7.6 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-08-27 by pgAdmin Development Team</li>
              </ul>
            </li>
...
<!-- Blog -->
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/68E"> HNSW Indexes with Postgres and pgvector</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/68s"> PostgreSQL 16 improves infinity:  PgSQLPhriday #012</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/68m"> Bi-directional replication using origin filtering in PostgreSQL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/68r"> Optimizing Postgres&#x27;s Auto-Vacuum for Blazingly-High-Churn Tables</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/68l"> Open Source Bait and Switch: Licensing and Beyond</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-08-30</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?091761a7"></script>
